...
public class AudioSteganographyTxt {
    ...
    public static void hello(String inputAudioPath, String outputAudioPath, String secretFilePath) throws IOException {
        // Đọc nội dung từ file txt
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            AudioSteganographyTxt.hello(inputAudioPath, outputAudioPath, secretFilePath);
